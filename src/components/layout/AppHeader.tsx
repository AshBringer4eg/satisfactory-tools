...
const AppHeader = () => {
  ...
  const ukrainianPath = pathname.startsWith("/uk")
    ? pathname
    : `/uk${pathname}`;
          ...
          {languageOptions.map((language, index) => (
            <span key={language.value}>
              ...
              <NavLink
                ...
                aria-current={
                  activeLocale === language.value ? "page" : undefined
                }
