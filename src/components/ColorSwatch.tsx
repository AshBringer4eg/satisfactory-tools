...
import { t } from "@/i18n";
import { SwatchBook, Share2 } from "lucide-react";
import {
...
const ColorSwatch = ({
  ...
  const handleHarmonyOpen = useCallback(
    (event: React.MouseEvent<HTMLButtonElement>) => {
      event.preventDefault();
      event.stopPropagation();
      event.currentTarget.blur();
    ...
    return (
      <div
        ...
        style={{
          borderRadius: "2px",
          boxShadow:
            "inset 0 1px 0 0 rgba(255,255,255,0.05), 0 2px 4px rgba(0,0,0,0.3)",
    ...
    >
      ...
      <div className="relative w-full aspect-[5/3] flex">
        ...
        >
          ...
          <div
            className="absolute inset-x-0 z-10 px-1 overflow-hidden"
            style={{ bottom: "0.2rem" }}
          >
            <code
